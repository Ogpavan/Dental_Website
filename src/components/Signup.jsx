    ...
    <div className='lg:px-24'>
        <div className='flex justify-center items-center'>
            <div className='hidden lg:block'>
                <img src={signupimg} className='w-[25rem] py-7 opacity-90'/>
            </div>
        ...
        <div className="w-full bg-white rounded-lg  md:mt-0 sm:max-w-md xl:p-0 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" action="#">
                    ...
                    <div>
                        <label for="confirm-password" className="block mb-2 text-md font-medium text-gray-900 ">Confirm password</label>
                    ...
                    <button type="submit" className="w-full text-white bg-[#1376F8] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Create an account</button>
